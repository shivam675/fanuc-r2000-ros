...
def main():
    ...
    first_quad.position.x = 0.929 #x1
    first_quad.position.y = 0.0 #y1
    first_quad.position.z = 0.649
    first_quad.orientation.x = 0.0
    first_quad.orientation.y = 0.0
    first_quad.orientation.z = -0.707
    first_quad.orientation.w = 0.707
    ...
    # second_quad.position.z = 0.649
    # second_quad.orientation.x = 0.0
    # second_quad.orientation.y = 0.0
    # second_quad.orientation.z = -0.707
    # second_quad.orientation.w = 0.707
    ...
    #     middle_waypoints_one.position.z = 0.649
    #     middle_waypoints_one.orientation.x = 0.0
    #     middle_waypoints_one.orientation.y = 0.0
    #     middle_waypoints_one.orientation.z = -0.707
    #     middle_waypoints_one.orientation.w = 0.707
    ...
    #     middle_waypoints_two.position.z = 0.649
    #     middle_waypoints_two.orientation.x = 0.0
    #     middle_waypoints_two.orientation.y = 0.0
    #     middle_waypoints_two.orientation.z = -0.707
    #     middle_waypoints_two.orientation.w = 0.707
